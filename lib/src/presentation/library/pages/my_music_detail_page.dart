...
class MyMusicDetailPage extends StatefulWidget {
  final List<SongModel>? cachedSongs;
  final String? title;
  const MyMusicDetailPage({
    super.key,
    this.cachedSongs,
    this.title,
  });
  @override
  State<MyMusicDetailPage> createState() => _MyMusicDetailPageState();
}

class _MyMusicDetailPageState extends State<MyMusicDetailPage>
        ...
        body: !added
            ...
            : Material(
                ...
                CoverSliverAppBar(
                  ...
                  cover: OfflineAudioQuery.offlineArtworkWidget(
                    id: _songs[0].id,
                    type: ArtworkType.AUDIO,
                    tempPath: tempPath!,
                    fileName: _songs[0].displayNameWOExt,
                  ),
