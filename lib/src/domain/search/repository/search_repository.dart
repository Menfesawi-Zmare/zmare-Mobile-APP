...
abstract class ISearchRepository {
  Future<Either<Failure,TrackList>> fetchSongSearchResults(String query, int page);
  Future<Either<Failure,AlbumList>> fetchAlbumSearchResults(String query, int page);
  Future<Either<Failure,ArtistList>> fetchArtistSearchResults(String query, int page);
  Future<Either<Failure,PlaylistList>> fetchPlaylistSearchResults(String query, int page);
  Future<Either<Failure,ProfileList>> fetchProfileSearchResults(String query, int page);
  Future<Either<Failure,SuggestionList>> fetchSearchSuggestionResults(String query);
}
