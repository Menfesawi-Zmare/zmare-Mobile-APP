...
abstract class IAuthRepository {
  ...
  Future<Either<Failure,RegisterResponse>> registerNormal(String username, String password, String email);
  Future<Either<Failure,LoginResponse>> loginWithUsernameAndPassword(String username, String password);
  Future<Either<Failure,AuthProfile>> authProfile();
  Future<Either<Failure,UpdateAccountResponse>> updateBio(ProfileData profile);
  Future<Either<Failure,UpdateAccountResponse>> updateSocial(ProfileData profile);
  Future<Either<Failure,UpdateAccountResponse>> updateImage(File file, String imageType);
  Future<Either<Failure,UpdateAccountResponse>> changePassword(String currentPassword, String newPassword, String repeatPassword);
  ...
  Future<Either<Failure,CreatePlaylistResponse>> createPlaylist(CreatePlaylistModel createPlaylistModel);
  Future<Either<Failure,AddToPlaylistResponse>> addToPlaylist(PlaylistsRequestModel playlistsRequestModel);
  Future<Either<Failure,bool>> updatePlaylist(PlaylistUpdateRequestModel playlistUpdateRequestModel);
