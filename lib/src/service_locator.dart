...
import 'package:flutter_music_pro/src/utils/services/audio/audio_service.dart';
...
import 'package:flutter_music_pro/src/data/album/repository/album_repository_impl.dart';
import 'package:flutter_music_pro/src/data/artist/data_source/artist_data_source.dart';
import 'package:flutter_music_pro/src/data/artist/repository/artist_repository_impl.dart';
import 'package:flutter_music_pro/src/data/auth/data_sources/auth_data_source.dart';
import 'package:flutter_music_pro/src/data/auth/repository/auth_repository_impl.dart';
import 'package:flutter_music_pro/src/data/explorer/data_source/explorer_data_source.dart';
import 'package:flutter_music_pro/src/data/explorer/repository/explorer_impl.dart';
import 'package:flutter_music_pro/src/data/track/repositoy/track_repository_impl.dart';
import 'package:flutter_music_pro/src/data/playlist/data_sources/playlist_data_source.dart';
import 'package:flutter_music_pro/src/data/playlist/repository/playlist_repository_impl.dart';
import 'package:flutter_music_pro/src/data/profile/data_sources/profile_data_source.dart';
import 'package:flutter_music_pro/src/data/profile/repository/profile_repository_impl.dart';
import 'package:flutter_music_pro/src/data/search/data_sources/search_data_source.dart';
import 'package:flutter_music_pro/src/data/search/repository/search_repository_impl.dart';
...
import 'package:flutter_music_pro/src/presentation/search/bloc/search_bloc.dart';
