...
abstract class ITrackDataSource {
  ...
  Future<Either<Failure,CommentResponse>> addTrackComment(int trackId, String comment);
  Future<Either<Failure,LoadCommentResponse>> loadTrackComment(int trackId, int page);
  Future<Either<Failure,CommentResponse>> editTrackComment(int commentId, String comment);
  Future<Either<Failure,bool>> deleteTrackComment(int commentId);
  Future<Either<Failure,bool>> trackReport(TrackReportRequestModel trackReportRequestModel, int trackId);
}
...
class TrackDataSource extends ITrackDataSource {
  ...
  @override
  Future<Either<Failure, TrackList>> getArtistTracks(
  ...
  Future<Either<Failure, LoadCommentResponse>> loadTrackComment(int trackId, int page) async{
     final response = await _client.getRequest(
      ...
      queryParameters: {'page': page},
      converter: (response) =>
          LoadCommentResponse.fromJson(response),
    );
    return response;
  }
